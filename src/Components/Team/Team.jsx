...
const Team = () => {
  ...
  const [teachers, teacherindex] = useSelector((state) => [
    state.TeacherReducer.teachers,
    state.TeacherReducer.teacher_index,
  ]);
    ...
    <>
      <section className="py-6 dark:bg-gray-800 dark:text-gray-100">
        <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
          <p className="p-2 text-sm font-medium tracki text-center">
            Bilişim Sektöründe adını altın harfler ile yazdırmış
          </p>
              ...
              <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-200 bg-gray-400 dark:text-gray-800">
                <Modal show={show} onHide={handleClose}>
                  <Modal.Header closeButton>
                    <Modal.Title>
                      {teachers[teacherindex].first_name +
                        " " +
                        teachers[teacherindex].last_name}
                    </Modal.Title>
                  </Modal.Header>
                  <Modal.Body className="text-center">
                    <img
                      ...
                      src={teachers[teacherindex].avatar}
                    />
                    <div>{teachers[teacherindex].email}</div>
                    <div>{teachers[teacherindex].phone_number}</div>
                    <div>
                      {teachers[teacherindex].address.city +
                        " " +
                        teachers[teacherindex].address.country +
                        " " +
                        teachers[teacherindex].address.state +
                        " " +
                        teachers[teacherindex].address.street_address}
                    </div>
                  </Modal.Body>
                  <Modal.Footer>
                    <Button
                ...
                <div className="flex-1 my-4">
                  <a href="#" className="text-xl font-semibold leadi">
